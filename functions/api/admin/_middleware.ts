...
// Gates every /api/admin/* route: no session -> 401, signed in but below
// admin rank (club_member/outsider) -> 403. Admin (or owner) gets attached
// to context.data for handlers.
